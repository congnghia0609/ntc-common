...
public class ImageInfoUtils {
	...
	public ImageInfoUtils(File file) throws IOException {
	...
	public ImageInfoUtils(InputStream is) throws IOException {
		processStream(is);
	}

	public ImageInfoUtils(byte[] bytes) throws IOException {
